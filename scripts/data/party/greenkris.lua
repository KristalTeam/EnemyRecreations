local character, super = Class(PartyMember, "greenkris")

function character:init()
    super.init(self)

    -- Display name
    self.name = "Green Kris"

    -- Actor (handles overworld/battle sprites)
    self:setActor("greenkris")
    ...
    self.menu_icon = "party/greenkris/head"
    -- Path to head icons used in battle
    self.head_icons = "party/greenkris/icon"
    -- Name sprite
    self.name_sprite = "party/greenkris/name"
